 ...
 * program to perform the conversions and display the correct temperature.
 *
...
public class TempConv extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jTextTemp, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
    ...
    private void jButtonConvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConvertActionPerformed
        ...
        String target = "";
        double temp = Double.parseDouble(this.jTextTemp.getText());
        if (this.jRadioButtonC.isSelected()) {
            temp = 9.0 * temp / 5.0 + 32;
            target = "Fahrenheit";
        } else {
            temp = 5.0 * (temp - 32) / 9.0;
            target = "Celcius";
        }
        this.jLabelAnswer.setText(String.format("%f degrees %s", temp, target));
